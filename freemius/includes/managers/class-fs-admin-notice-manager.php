<?php
     ...
     * @license     https://www.gnu.org/licenses/GPLv2-3.0.html GNU General Public License Version 3
     * @since       1.0.7
     */
    ...
    class FS_Admin_Notice_Manager {
        ...
        function _admin_notices_hook() {
            ...
            $show_admin_notices = ( ! $this->is_blocksbakery_page() );
        ...
        /**
         * Check if the current page is the blocksbakery block editor.
         *
         * @author Vova Feldman (@svovaf)
         * @since  2.2.3
         *
         * @return bool
         */
        function is_blocksbakery_page() {
            if ( function_exists( 'is_blocksbakery_page' ) &&
                 is_blocksbakery_page()
            ) {
                // The blocksbakery plugin is on.
                return true;
            }
