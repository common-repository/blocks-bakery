...
if (!class_exists('BB_ICON_LIST')) {
    ...
    class BB_ICON_LIST
    {
        ...
        {
            add_action('init', array( $this, 'iconListBlockRegister' ));
        }
        /**
         * Icon_list_block_register
         *
         * @return void
         */
        public function iconListBlockRegister()
        {
    
            // Register our block script with WordPress
            wp_register_script(
                'gb-icon-list-script',
                plugins_url('../../build/icon-list/main.js', __FILE__),
                array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor' )
            );

            wp_register_style(
                'gb-icon-list-style',
                plugins_url('../../build/icon-list/editor.css', __FILE__),
        ...
        wp_enqueue_style('gb_familycss');
            ...
            register_block_type(
                'blocksbakery/icon-list',
                array(
                    'editor_script' => 'gb-icon-list-script',
                    'style'         => 'gb-icon-list-style',
                )
            );
        }
    }
