...
if (!class_exists('BB_BLOCK_QUOTE')) {
    /**
     * BB_BLOCK_QUOTE
     *
    ...
    class BB_BLOCK_QUOTE
    {
        ...
        {
            add_action('init', array( $this, 'blockQuoteBlockRegister' ));
        }
        /**
         * Block_quote_block_register
         *
         * @return void
         */
        public function blockQuoteBlockRegister()
        {

            // Register our block script with WordPress
            wp_register_script(
                'gb-block-quote-script',
                plugins_url('../../build/block-quote/main.js', __FILE__),
                array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor' )
            );

            // Register our block's base CSS
            wp_register_style(
                'gb-block-quote-style',
                plugins_url('../../build/block-quote/style.css', __FILE__),
                array( 'wp-blocks' )
            );
            ...
            wp_register_style(
                'gb-block-quote-editor-style',
                plugins_url('../../build/block-quote/editor.css', __FILE__),
            ...
            register_block_type(
                'blocksbakery/block-quote',
                array(
                'editor_script' => 'gb-block-quote-script',
                'editor_style'  => 'gb-block-quote-style',
