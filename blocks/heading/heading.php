...
if (!class_exists('BB_HEADING')) {
  ...
  class BB_HEADING
  {
    ...
    {
      add_action('init', array($this, 'headingblockregister'));
    }
    /**
     ...
     * @return void
     */
    public function headingblockregister()
    {

      // Register our block script with WordPress
      wp_register_script(
        'gb-heading-script',
        plugins_url('../../build/heading/main.js', __FILE__),
      ...
      // wp_register_style(
      //     'gb-advanced-heading-script-style',
      //     plugins_url('../../build/advanced-heading/script.js', __FILE__),
      ...
      register_block_type(
        ...
        array(
          ...
          'editor_script' => 'gb-heading-script',
          'editor_style'  => 'gb-heading-style',
          'style'         => 'gb-heading-editor-style',
          // 'script'    => 'gb-advanced-heading-script-style'
          'render_callback'   => 'simple_heading_render_callback',
...
function simple_heading_render_callback($attributes)
{
  $heading_style  = '';


  $heading_style .= ($attributes['text_decoration'] != 'none') ? "text-decoration: " . $attributes['text_decoration'] . ";" : '';
  $heading_style .= ($attributes['title_color'] != 'black') ? "color: " . $attributes['title_color'] . $attributes['title_opacity'] . ";" : 'color:black';
  $heading_style .= ($attributes['title_family'] != 'ABeeZee') ? "font-family: " . $attributes['title_family'] . ";" : '';
  $heading_style .= ($attributes['title_weight'] != 'regular') ? "font-weight: " . $attributes['title_weight'] . ";" : '';
  $heading_style .= ($attributes['title_size'] . $attributes['pxfortile'] != '30px') ? "font-size: " . $attributes['title_size'] . $attributes['pxfortile'] . ";" : '';

  $heading_style .= ($attributes['text_transform'] != 'none') ? "text-transform: " . $attributes['text_transform'] . ";" : '';
  $heading_style .= ($attributes['title_height'] . $attributes['lineheightpxemfortitle'] != '1.5em') ? "line-height: " . $attributes['title_height'] . $attributes['lineheightpxemfortitle'] . ";" : '';
  $heading_style .= ($attributes['letter_spacing_title'] != 0) ? "letter-spacing: " . $attributes['letter_spacing_title'] . "px;" : '';
  $heading_style .= ($attributes['text_shadow_horizental'] . "px " . $attributes['text_shadow_vertical'] . "px " . $attributes['title_shadow_blur'] . "px " . $attributes['text_shadow_clors'] != '0px 0px 0px black') ? "text-shadow: " . $attributes['text_shadow_horizental'] . "px " . $attributes['text_shadow_vertical'] . "px " . $attributes['title_shadow_blur'] . "px " . $attributes['text_shadow_clors'] . ";" : '';
  $heading_style .= ($attributes['blend_mode'] != 'normal') ? "mix-blend-mode: " . $attributes['blend_mode'] . ";" : '';
  $heading_style .= ($attributes['font_style'] != 'inherit') ? "font-style: " . $attributes['font_style'] . ";" : '';
  $heading_style .= ($attributes['title_align'] != 'left') ? "text-align: " . $attributes['title_align'] . ";" : '';
  $heading_style   = (($heading_style != '') ? ' style="' . $heading_style . '"' : '');



  $iheg_block = '';
  $iheg_block .= '<div class="bb-heading-main" style="text-align:' . $attributes['title_align'] . ' "><a class="bb-heading-link" style="text-decoration:none; color: black"  href=' . $attributes['title_link'] . ' target=' . $attributes['open_tab'] . ' rel=' . $attributes['rel_nofollow'] . '>';
  $iheg_block .= '<' . $attributes['heading'] . ' ' . $heading_style . 'class="bb-heading-content">' . $attributes['content_heading'] . '</' . $attributes['heading'] . '>';
  $iheg_block .= '</a>';
