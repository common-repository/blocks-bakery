...
if (!class_exists('BB_CALL_TO_ACTION')) {
    /**
     * BB_CALL_TO_ACTION
     *
    ...
    class BB_CALL_TO_ACTION
    {
        ...
        {
            add_action('init', array( $this, 'callToActionBlockRegister' ));
        }
        /**
         * Call_to_action_block_register
         *
         * @return void
         */
        public function callToActionBlockRegister()
        {

            // Register our block script with WordPress
            wp_register_script(
                'gb-call-to-action-script',
                plugins_url('../../build/call-to-action/main.js', __FILE__),
                array( 'wp-blocks', 'wp-i18n', 'wp-components', 'wp-editor' )
            );

            wp_register_style(
                'gb-call-to-action-style',
                plugins_url('../../build/call-to-action/style.css', __FILE__),
                array( 'wp-blocks' )
            );
            ...
            wp_register_style(
                'gb-call-to-action-editor-style',
                plugins_url('../../build/call-to-action/editor.css', __FILE__),
            ...
            register_block_type(
                'blocksbakery/call-to-action',
                array(
                'editor_script' => 'gb-call-to-action-script',
                'editor_style'  => 'gb-call-to-action-style',
                'style'         => 'gb-call-to-action-editor-style',
                )
            );
        }
    }
}
new BB_CALL_TO_ACTION();
