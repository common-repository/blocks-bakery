...
if (!class_exists('BB_ADVACED_HEADING')) {
    /**
     * BB_ADVACED_HEADING
     *
    ...
    class BB_ADVACED_HEADING
    {
        ...
        {
            add_action('init', array( $this, 'advancedheadingblockregister' ));
        }
        /**
         ...
         * @return void
         */
        public function advancedheadingblockregister()
        {

            // Register our block script with WordPress
            wp_register_script(
                'gb-advanced-heading-script',
                plugins_url('../../build/advanced-heading/main.js', __FILE__),
                array( 'wp-blocks', 'wp-i18n', 'wp-components', 'wp-editor' )
            );

            // Register our block's base CSS
            wp_register_style(
                'gb-advanced-heading-style',
                plugins_url('../../build/advanced-heading/style.css', __FILE__),
                array( 'wp-blocks' )
            );
            ...
            wp_register_style(
                'gb-advanced-heading-editor-style',
                plugins_url('../../build/advanced-heading/editor.css', __FILE__),
            ...
            register_block_type(
                'blocksbakery/advanced-heading',
                array(
                'editor_script' => 'gb-advanced-heading-script',
                'editor_style'  => 'gb-advanced-heading-style',
                'style'         => 'gb-advanced-heading-editor-style',
