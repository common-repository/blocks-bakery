...
if (!class_exists('BB_INFO_BOX')) {
    ...
    class BB_INFO_BOX
    {
        ...
        {
            add_action('init', array( $this, 'infoBoxBlockRegister' ));
        }
        /**
         * Info_box_block_register
         *
         * @return void
         */
        public function infoBoxBlockRegister()
        {
    
            // Register our block script with WordPress
            wp_register_script(
                'gb-info-box-script',
                plugins_url('../../build/info-box/main.js', __FILE__),
            ...
            wp_register_style(
                'gb-info-box-style',
                plugins_url('../../build/info-box/style.css', __FILE__),
                array( 'wp-blocks' )
            );
            ...
            wp_register_style(
                'gb-info-box-editor-style',
                plugins_url('../../build/info-box/editor.css', __FILE__),
            ...
            register_block_type(
                'blocksbakery/info-box',
                array(
                    'editor_script' => 'gb-info-box-script',
                    'editor_style'  => 'gb-info-box-style',
                    'style'         => 'gb-info-box-editor-style',
                )
            );
        }
    }
