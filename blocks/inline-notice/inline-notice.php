...
if (!class_exists("BB_INLINE_NOTICE")) {
    /**
     * BB_INLINE_NOTICE
     *
     * @category  blocks_bakery
     * @package   Inline_Notice
    ...
    class BB_INLINE_NOTICE
    {
        ...
        {
            add_action('init', array( $this, 'inLineNoticeBlockRegister' ));
        }
        /**
         * Inline_notice_block_register
         *
         * @return void
         */
        public function inLineNoticeBlockRegister()
        {
    
            // Register our block script with WordPress
            wp_register_script(
                'gb-inline-notice-script',
                plugins_url('../../build/inline-notice/main.js', __FILE__),
                array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor' )
            );
    
            // Register our block's base CSS
            wp_register_style(
                'gb-inline-notice-style',
                plugins_url('../../build/inline-notice/editor.css', __FILE__),
            ...
            wp_register_style(
                'gb_familycss',
                'https://fonts.googleapis.com/css?family=ABeeZee|Abel|Abhaya+Libre|
                Abril+Fatface|Aclonica|Acme|Actor|Adamina|
            ...
            register_block_type(
                'blocksbakery/inline-notice',
                array(
                    'editor_script' => 'gb-inline-notice-script',
                    'style'         => 'gb-inline-notice-style',
                )
            );
        }
    }
