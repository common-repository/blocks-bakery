...
if (!class_exists('BB_MARKETING_BUTTON')) {
    /**
     * BB_MARKETING_BUTTON
     *
    ...
    class BB_MARKETING_BUTTON
    {
        ...
        {
            add_action('init', array( $this, 'marketingButtonBlockregister' ));
        }
        /**
         ...
         * @return void
         */
        public function marketingButtonBlockregister()
        {
    
            // Register our block script with WordPress
            wp_register_script(
                'gb-marketing-button-script',
                plugins_url('../../build/marketing-button/main.js', __FILE__),
                array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor' )
            );

     // Register our block's base CSS
     wp_register_style(
        'gb-marketing-button-style',
        plugins_url('../../build/marketing-button/editor.css', __FILE__),
        array( 'wp-edit-blocks' )
            ...
            register_block_type(
                'blocksbakery/marketing-button',
                array(
                    'editor_script' => 'gb-marketing-button-script',
                    'style'         => 'gb-marketing-button-style',
                )
            );
        }
    }
